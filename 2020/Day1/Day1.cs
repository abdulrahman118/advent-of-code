...
using System.Text.RegularExpressions;
 ...
 namespace Dcoder
 {
   public class Program
   {
     ...
     private static int threeNumberSum(int[] input,int sum)
     {
       int result = 0;       
       ...
       {
         int value = twoNumberSum(input.Skip(i+1).Take(length-(i+1)).ToArray(),(sum-input[i]));
